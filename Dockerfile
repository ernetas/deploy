...
ARG TERRAFORM_VERSION="1.1.8" https://github.com/hashicorp/terraform/releases
ARG TERRAGRUNT_VERSION="v0.36.6" # https://github.com/gruntwork-io/terragrunt/releases
ARG HELM_PLUGIN_VERSION_SECRETS="v3.13.0" # https://github.com/jkroepke/helm-secrets/releases
